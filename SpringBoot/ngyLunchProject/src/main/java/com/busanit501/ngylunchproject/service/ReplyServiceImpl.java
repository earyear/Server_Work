...
import com.busanit501.ngylunchproject.repository.ReplyRepository;
...
public class ReplyServiceImpl implements ReplyService {
    ...
    public Long register(ReplyDTO replyDTO) {
        ...
        Optional<Lunch> result = lunchRepository.findById(replyDTO.getBno());
        Lunch lunch = result.orElseThrow();
        reply.setLunch(lunch);
    ...
    public ReplyDTO read(Long rno) {
        ...
        replyDTO.setBno(reply.getLunch().getBno());
    ...
    @Override
    public PageResponseDTO<ReplyDTO> getListOfLunch
